...
Subject to the license terms, you may share and adapt the licensed material for any purpose, including commercial purposes.
...
This license applies to original copyrightable repository material, including documentation, protocols, diagrams, and datasets, unless a file or credited third-party component states otherwise.

Copyright does not protect the underlying ideas, facts, recipes, procedures, processes, systems, or methods of operation. Accordingly, this license governs reuse of the repository's copyrightable expression; it is not the source of permission to perform the underlying Diamond Brew method.
...
The licensed material is offered as-is and without warranties, subject to the complete CC BY 4.0 legal code. It is not a validated food-safety process, equipment certification, or substitute for manufacturer instructions, regulatory requirements, qualified engineering review, or process-authority evaluation.
